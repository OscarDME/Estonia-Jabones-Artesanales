...
export const copy = {
  metadata: {
    title: "EkoTaim — Valmista käsitööseepe ja looduskosmeetikat kodus",
    description:
      "EkoTaimi käsitööseepide ja looduskosmeetika kursus: õpi valmistama looduslikke tooteid endale ja oma perele. Üle 27 juhendi, 500 retsepti ja 3 TASUTA boonust. Eluaegne ligipääs 80% soodustusega.",
    lang: "et",
  },
  ...
  hero: {
    ...
    kicker: "Juba üle 2586 inimese valmistab oma tooteid kodus",
    headlinePre: "LOODUSKOSMEETIKA EKSPERT PALJASTAB,",
    headlineHighlight: "kuidas luua lõhnavaid seepe,",
    headlinePost: "mis hoolitsevad sinu naha eest juba esimesest päevast",
    supporting:
      "Ideaalne kõigile, kes soovivad KOHE alustada oma looduslike seepide valmistamist — ilma keemiata, ilma liigsete kuludeta ja päris rõõmuga.",
    cta: "Tahan kohe ligipääsu 🧼",
    imageAlt: "Hoolitsetud ja särava nahaga naine tänu EkoTaimi looduskosmeetikale",
    trustChips: [
      { icon: "⭐", text: "Üle 2586 õpilase" },
      { icon: "🎁", text: "3 TASUTA boonust" },
      { icon: "🛡️", text: "14-päevane garantii" },
    ],
  },

  instructorIntro: {
    quote:
      "Lõin selle kursuse just sulle – naisele, kes armastab oma kätega luua ja soovib hoolitseda enda ja oma lähedaste eest looduslikul moel.",
  },
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "TrendingUp", text: "Muuda loomine päris rõõmuks oma kodus." },
    ],
    checklist: [
  ...
  trending: {
    ...
    headline:
      "vaid paari päevaga õpid looma trendikaid seepe, millega võlud kõiki",
  ...
  megapack: {
    ...
    items: [
      { bold: "Täielik samm-sammuline juhend —", rest: " algajast edasijõudnu tasemele" },
    ...
    imageAlt: "EkoTaimi käsitööseepide megapaketi näidis",
  },

  bonuses: {
    kicker: "TASUTA BOONUSED",
    headline: "Kui ostad täna, saad 3 TASUTA boonust!",
    subheadline: "Lisajuhendid digitaalses allalaaditavas PDF-formaadis.",
    badge: "BOONUS #",
    freeLabel: "TASUTA",
    items: [
      { image: "/bonuses/bonus-1.webp", title: "Kehakosmeetika", desc: "Looduslikud retseptid kehavõide, ihupiimade ja koorijate valmistamiseks." },
      { image: "/bonuses/bonus-6.webp", title: "Vannisoolad", desc: "Lõõgastu isetehtud aroomisoolade ja kihisevate vannipallidega." },
      { image: "/bonuses/bonus-7.webp", title: "Tahke šampoon", desc: "Terved juuksed ilma plastpakendi ja keemiata." },
    ],
  ...
  features: {
    ...
    subheadline: "Täielik ligipääs ja allalaaditavad materjalid (PDF).",
    items: [
      ...
      { icon: "Sparkles", title: "Praktilised teadmised", desc: "Kõik, mida vajad, et oma esimesed tooted kohe valmistada." },
      { icon: "ShieldCheck", title: "14-päevane garantii", desc: "Kui sa pole rahul, maksame 100% rahast tagasi." },
    ],
  },
  ...
  primaryPricing: {
    ...
    imageAlt: "EkoTaimi programmi eksklusiivse soodustuse näidis",
  ...
  socialProof: {
    ...
    subheadlinePost: "naudib oma isetehtud looduslikke tooteid kodus!",
  },

  reviewScreenshots: {
    headline: "Päris sõnumid meie õpilastelt",
    subheadline: "Seda saame iga päev.",
    onlineLabel: "võrgus",
    ...
    items: [
      ...
      },
      {
        ...
        timeLabel: "eile",
        messages: [
          { text: "Eile õhtul tegin lavendliseepe kogu perele 💜" },
          { text: "Ema lihtsalt armastab neid, ütleb et ta nahk on hoopis teistsugune 🙌" },
      ...
      },
      {
        ...
        timeLabel: "12:05",
        messages: [
          { text: "Alustasin 2 nädalat tagasi ja mul on juba terve kollektsioon 💕" },
      ...
      },
      {
        ...
        timeLabel: "täna",
        messages: [
          { text: "Tsau! Tahtsin lihtsalt tänada 🌿" },
          { text: "Tegin endale tahke šampooni ja nahk pole enam kuiv" },
    ...
    courses: [
      {
        ...
        lessons: [
          "EkoTaimi seebid Moodul 1",
          "EkoTaimi seebid Moodul 2",
  ...
  finalCta: {
    ...
    headline: "Hangi EkoTaimi megapakett TÄNA uskumatu soodustusega",
    subUrgency:
      "Üle 2586 inimese valmistab juba oma käsitööseepe ja kosmeetikat kodus. Täna on sinu kord.",
    bundleList: [
      ...
      "BOONUS — Kehakosmeetika",
      "BOONUS — Vannisoolad",
      "BOONUS — Tahke šampoon",
      "Eluaegne ligipääs (PDF/veebis)",
    ],
    guaranteeText:
      "Täielik 14-päevane garantii. Kui kursus sulle ei meeldi, maksame küsimusi esitamata 100% rahast tagasi.",
    guaranteeImageAlt: "14-päevase garantii pitser",
    ...
    trustRow: "100% turvaline makse · Kohene ligipääs · 14-päevane garantii",
  },

  instructorBio: {
    name: "Evelin Sepp",
    title: "Looduskosmeetika ekspert",
    bio: "Hei, mina olen Evelin. Olen looduskosmeetika ja seebivalmistamisega tegelenud juba üle 8 aasta. See, mis algas isiklikust vajadusest oma naha eest ilma keemiata hoolitseda, muutus mu suurimaks kireks... ja ka elustiiliks. Aastate jooksul olen välja töötanud kümneid isiklikke retsepte ja aidanud paljudel naistel teha esimesi samme selles põnevas maailmas — valmistada esimene seep koduste vahenditega ja avastada rõõm enda ja oma lähedaste eest hoolitsemisest looduslikul moel. Ma tean, mis tunne on alustada nullist, ilma kogemusteta, kartes vigu teha või mitte teades, kust alustada. Seetõttu jagan sellel kursusel kõike, mida olen õppinud – selgelt, praktiliselt ja ilma liigse keerukuseta.",
  ...
  testimonials: {
    headline: "Mida räägivad need, kes on kursuse juba läbinud",
    subheadline: "Päris arvustused meie EkoTaimi kursuse õpilastelt.",
    productLabel: "EkoTaim — Käsitööseepide kursus",
    ...
    items: [
      {
        name: "Jana Tamm",
        handle: "@jana_t",
        text: "Mulle kursus väga meeldis. Tegin kõike täpselt nii, nagu õpetaja näitas, ja vähem kui kuuga oli mul terve kollektsioon oma seepe kogu perele. Mu laste nahk on märgatavalt paranenud, sellest ajast peale, kui me kasutame ainult mu enda tehtud looduslikke tooteid. Aitäh selle kursuse eest, see on tõesti seda väärt.",
      },
      {
        name: "Mari Kuusk",
        handle: "",
        text: "Lõpetasin kursuse nädal tagasi ja olen täiesti lummatud. Olen juba oma esimesed seebid valmis teinud, katsetasime neid kodus ja kõik on vaimustuses. Mu nahk tundub palju pehmem ja niisutatum ning lõhnad on uskumatud. Suur tänu teile selle võimaluse eest. Iga sent oli asja ette läinud.",
      },
      {
        name: "Tiina Lepp",
        handle: "",
        text: "Jätan selle kommentaari, sest läbisin kursuse mõni aeg tagasi ja sellest ajast peale ei ole ma ostnud ühtegi tööstuslikku seepi. Kogu pere kasutab mu looduslikke tooteid ja vahe nahale on tohutu. Ma poleks kunagi arvanud, et saan kodus nii kvaliteetseid asju valmistada. AITÄH. See kursus on erakordselt hea investeering.",
      },
      {
        name: "Martin Kivi",
        handle: "@martin_k",
        text: "Suurepärane sisu, väga selge ja professionaalne. Need kingituseks saadud boonused... kui teil on võimalus need võtta, siis tehke seda. Väga väärtuslik info. Olge terved ja suur tänu, et neid teadmisi meiega jagate.",
      },
    ],
  ...
  closingProof: {
    headlinePre: "Meie õpilased valmistavad oma esimesi seepe",
    headlineHighlight: "juba esimese nädala jooksul",
    headlinePost: ". Mida sa ootad?",
    ctaLabel: "ALUSTA TÄNA",
  },

  guarantee: {
    badgeLabel: "14-PÄEVANE GARANTII",
    headline: "ÄRA MURETSE, ME VÕTAME RISKI ENDA KANDA.",
    text: "Sul on kaks nädalat aega kursust katsetada ja kui see sulle ei meeldi või ei vasta sinu ootustele, tagastame sulle 100% rahast.",
    badgeAlt: "EkoTaimi 14-päevase garantii pitser",
    certs: [
      { icon: "Award", label: "Kontrollitud kvaliteet" },
      { icon: "ShieldCheck", label: "100% turvaline makse" },
      { icon: "Lock", label: "Andmekaitse" },
      { icon: "BadgeCheck", label: "Rahulolevad õpilased" },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "Kas alustamiseks on vaja suurt investeeringut?",
      ...
      },
      {
        ...
        a: "Kursus sisaldab eluaegset ligipääsu, samm-sammulisi e-raamatuid, allalaaditavaid materjale (PDF) ja tehnilist tuge.",
      },
      {
        q: "Mis siis, kui kursus mulle ei meeldi?",
        a: "Sul on täielik 14-päevane garantii. Kui sa mingil põhjusel pole rahul, kirjuta meile ja me tagastame sulle 100% rahast, ilma küsimusteta.",
      },
    ],
  },
